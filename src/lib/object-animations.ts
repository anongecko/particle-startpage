...
export class ObjectAnimator {
	...
	private interpolateStates(
		...
		if (from.rotation && to.rotation) {
			this.currentState.rotation.x = this.lerp(from.rotation.x, to.rotation.x, t);
			this.currentState.rotation.y = this.lerp(from.rotation.y, to.rotation.y, t);
			this.currentState.rotation.z = this.lerp(from.rotation.z, to.rotation.z, t);
		}
		...
		if (from.lightIntensity !== undefined && to.lightIntensity !== undefined) {
			this.currentState.lightIntensity = this.lerp(from.lightIntensity, to.lightIntensity, t);
		}
